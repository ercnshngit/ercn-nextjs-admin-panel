...
import { DatabaseTableColumn } from "@/lib/database/models/example_models/database-table-column.model";
import { DatabaseTable } from "@/lib/database/models/example_models/database-table.model";
